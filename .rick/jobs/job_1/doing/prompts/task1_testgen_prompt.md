...
**Task ID**: task1
**Task Name**: 创建 okf-knowledge-read 技能目录结构和 SKILL.md 骨架及核心流程指令
**Task Goal**: 在 `skills/okf-knowledge-read/` 下创建技能目录，编写 SKILL.md 的主干内容：frontmatter 元数据、触发条件、前置准备、运行参数说明，以及核心 5 步 Pipeline 指令（发现知识库 → 匹配概念 → 加载文档 → 追踪链接 → 注入上下文）。
...
请创建测试脚本到: `/Users/xuning/IdeaProjects/skills/.rick/jobs/job_1/doing/tests/task1.py`
...
- 脚本应该可以直接运行: `python3 /Users/xuning/IdeaProjects/skills/.rick/jobs/job_1/doing/tests/task1.py`
...
```bash
python3 /Users/xuning/IdeaProjects/skills/.rick/jobs/job_1/doing/tests/task1.py
```
